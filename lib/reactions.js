...
function saveAutoReactionState(state) {
    try {
        ...
        console.error('_Error saving auto-reaction state_:', error);
    }
}
...
async function addCommandReaction(sock, message) {
    try {
        ...
        console.error('_Error adding command reaction_:', error);
    }
}
    ...
    try {
        if (!isOwner) {
            await sock.sendMessage(chatId, { 
                text: '❌ _This command is only available for the owner_!',
                quoted: message
            });
            return;
        }
        ...
        if (action === 'on') {
            ...
            await sock.sendMessage(chatId, { 
                text: '✅ _Auto-reactions have been enabled globally_',
                quoted: message
            });
        } else if (action === 'off') {
            ...
            await sock.sendMessage(chatId, { 
                text: '✅ _Auto-reactions have been disabled globally_',
                quoted: message
            });
        } else {
